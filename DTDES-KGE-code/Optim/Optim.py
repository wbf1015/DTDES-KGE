...
def getoptimizer(args, params):
    ...
    if args.optimizer == 'SGD':
        return torch.optim.SGD(params, lr=args.learning_rate, momentum=args.momentum, weight_decay=args.weight_decay, nesterov=args.nesterov)
    
    elif args.optimizer == 'Adam':
        return torch.optim.Adam(params, lr=args.learning_rate, weight_decay=args.weight_decay, betas=args.betas, amsgrad=args.amsgrad)
